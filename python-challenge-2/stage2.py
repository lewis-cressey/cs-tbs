...
challenges = [
    Challenge(1, "Mark every power of 2", [ 2**x for x in range(8) ]),
    Challenge(2, "Mark the diagonal line", [ x for x in range(5, 200, 21) ]),
    Challenge(3, "Mark the cross", [ x for x in range(5, 200, 21) ] + [ x for x in range(15, 200, 19) ]),
    Challenge(4, "Mark every number in the geometric sequence", seq(1, lambda x: 2 * x + 1)),
    Challenge(5, "Mark the spiral", spiral(90)),
    Challenge(6, "You have completed every challenge!", [584639]),
]
