...
challenges = [
    ...
    Challenge(5, "Mark every number in the vertical line", range(8, 200, 20)),
    Challenge(6, "Mark every multiple of 3 in the table", range(0, 200, 3)),    
    Challenge(7, "Mark the diagonal line", [ x for x in range(5, 200, 21) ]),
    Challenge(8, "Mark every multiple of 3 which is not also a multiple of 9", [ x for x in range(0, 200, 3) if x % 9 != 0 ]),
    Challenge(9, "Mark every power of 2", [ 2**x for x in range(8) ]),
    Challenge(10, "Mark the cross", [ x for x in range(5, 200, 21) ] + [ x for x in range(15, 200, 19) ]),
    Challenge(11, "Mark every number in the box shape", gen_box()),
    Challenge(12, "Mark every prime_number", gen_primes(200)),
    Challenge(13, "Mark every number in the geometric sequence", seq(1, lambda x: 2 * x + 1)),
    Challenge(14, "Mark the spiral", spiral(90)),
    Challenge(15, "You have completed every challenge!", [584639]),
]
